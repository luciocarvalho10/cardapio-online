...
- Use conventional commit types (feat, fix, docs, style, refactor, perf, test, chore) when the repository uses them. Otherwise, follow the existing style as closely as possible.
