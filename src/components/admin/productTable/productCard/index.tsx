...
export function ProductCard({ cat, productCard, toggleShowable, toggleAvailable, openEdit, handleDelete, deleteConfirm }: ProductCardProps) {
  return (
    <div className="group flex overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm transition-shadow duration-300 hover:shadow-lg md:hidden dark:border-gray-800 dark:bg-gray-900 dark:shadow-gray-900/60 dark:hover:shadow-gray-900">
      <div className="flex flex-col items-center gap-3 p-2">
        <div className="h-20 w-20 flex-shrink-0 overflow-hidden rounded-xl border border-gray-100 dark:border-gray-700">
          <img
